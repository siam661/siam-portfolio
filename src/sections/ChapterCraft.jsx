...
export default function ChapterCraft({ reducedMotion }) {
  ...
  return (
    <section
      ref={rootRef}
      className="relative py-32 md:py-44 px-6 md:px-10 bg-surface/40"
    >
      <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <ol className="flex flex-col md:flex-row md:justify-between gap-6 md:gap-2 md:pt-6">
              {STAGES.map(stage => (
                <li
                  key={stage}
                  className="craft-stage flex md:flex-col items-center md:items-start gap-3 md:gap-4"
                >
        ...
        <div className="md:col-span-6">
          <Suspense
            fallback={
              <div className="w-full min-h-[280px]" aria-hidden="true" />
            }
          >
